$(document).on("click", "#square-btn", function (e) {
                ...
                g_editor.setCustomProperties(rect);
                g_editor.canvas.add(rect);
                g_editor.centerObjectH(rect);
                g_editor.centerObjectV(rect);
                g_editor.canvas.sendBackwards(rect);
            ...
            // OPACITY SLIDER
            $("[id$='shape-opacity-slider ']").change(function () {
                var selected_object = g_editor.canvas.getActiveObject();
                if (selected_object != null)
                {
            ...
            $(document).on("click", "#circle-btn", function (e) {
                ...
                g_editor.setCustomProperties(circle);
                g_editor.canvas.add(circle);
                g_editor.centerObjectH(circle);
                g_editor.centerObjectV(circle);
                g_editor.canvas.sendBackwards(circle);
                g_editor.canvas.renderAll();
                circle.setCoords();
                g_editor.save_canvas();
            });
            ...
            $(document).on("click", "#triangle-btn", function (e) {
                ...
                g_editor.setCustomProperties(triangle);
                g_editor.canvas.add(triangle);
                g_editor.centerObjectH(triangle);
                g_editor.centerObjectV(triangle);
                g_editor.canvas.sendBackwards(triangle);
                g_editor.canvas.renderAll();
                triangle.setCoords();
                g_editor.save_canvas();
            });
            ...
            $(document).on("click", "#heart-btn", function (e) {
                ...
                g_editor.setCustomProperties(heart)
;
                g_editor.canvas.add(heart)
;
                g_editor.centerObjectH(heart)
;
                g_editor.centerObjectV(heart)
;
                g_editor.canvas.sendBackwards(heart)
;
                g_editor.canvas.renderAll();
                heart.setCoords();
                g_editor.save_canvas();
            ...
            $(document).on("click", ".polygon-btn", function (e) {
               ...
               if(!bg_color)//                console.log(nb_points);//                console.log(nb_points//                console.log(nb_points);//                console.log(nb_points););//                console.log(nb_points);
                        bg_color="#4f71b9";
                  if(!opacity)
                        opacity=1;
                var startPoints = [];
                ...
                g_editor.setCustomProperties(polygon);
                g_editor.canvas.add(polygon);
                g_editor.centerObjectH(polygon);
                g_editor.centerObjectV(polygon);
                g_editor.canvas.sendBackwards(polygon);
                g_editor.canvas.renderAll();
                polygon.setCoords();
                g_editor.save_canvas();
            });
            ...
            $(document).on("click", ".star-btn", function (e) {
                ...
                else if (nb_points == 10)
                {
                    startPoints = [
                        ...
                        g_editor.setCustomProperties(star)
;
                        g_editor.canvas.add(star)
;
                        g_editor.centerObjectH(star)
;
                        g_editor.centerObjectV(star)
;
                        g_editor.canvas.sendBackwards(star)
;
                        g_editor.canvas.renderAll();
                        star.setCoords();
                        g_editor.save_canvas();
